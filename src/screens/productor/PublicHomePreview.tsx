...
const PublicHomePreview: React.FC<PublicHomeProps> = ({ navigation }) => {
              ...
              <View style={styles.recentWorkInfo}>
                ...
                <View style={styles.recentWorkItem}>
                  ...
                  <Text style={styles.recentWorkText}>
                    ...
                    {(item.workersNeeded || 1) === 1 ? "persona" : "personas"}
                  </Text>
                </View>
              </View>
      ...
      <TouchableOpacity
        ...
        style={[
          styles.jobCard,
          {
            marginBottom:
              index ===
              (isNearbyTab ? getNearbyOffers() : filteredOffers).length - 1
                ? 20
                : 16,
          },
        ]}
          ...
          <View style={styles.jobTags}>
            ...
            {isNearbyTab && item.includesLodging && (
              <View style={[styles.jobTag, styles.nearbySpecialTag]}>
                <Text style={styles.nearbySpecialTagText}>
                  Incluye alojamiento
                </Text>
              </View>
            )}
    ...
    <View style={styles.container}>
      <ScreenLayout navigation={navigation}>
            ...
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                ...
                <Text style={styles.resultsCount}>
                  {activeTab === "nearby"
                    ? selectedCountry
                      ? `${getNearbyOffers().length} resultado${
                          getNearbyOffers().length !== 1 ? "s" : ""
                        }`
                      : "Selecciona un país"
                    : `${filteredOffers.length} resultado${
        ...
        <CustomTabBar
          ...
          currentRoute="PublicHomePreview"
        />
      </ScreenLayout>
    </View>
  );
